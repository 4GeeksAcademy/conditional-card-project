  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
           ...
           <li><a href="https://github.com/${variables.github}"/><i class="fab fa-github"></i></li>
            <li><a href="https://linkedin.com/in/${variables.linkedin}"/><i class="fab fa-linkedin"></i></li>
           <li><a href="https://instagram.com/${variables.instagram}"><i class="fab fa-instagram"></i></li>
          </ul>
        </div>`;
}
